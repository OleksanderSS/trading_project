...
Usage:
    python -m dean_os.draft.dean_os_agent_system_v7.dean_os.build_keyword_index
    python -m dean_os.draft.dean_os_agent_system_v7.dean_os.build_keyword_index --rebuild
"""
