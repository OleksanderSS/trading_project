...
from dean_os.draft.dean_os_agent_system_v7.dean_os.analyst_evidence_pack import AnalystEvidencePackRunner, documents_from_evidence_pack
from dean_os.draft.dean_os_agent_system_v7.dean_os.historical_replay import HistoricalReplayRunner
from dean_os.draft.dean_os_agent_system_v7.dean_os.market_data_api import parse_datetime
...
class HistoricalResearchReplayRunner:
    ...
    async def run(
        ...
        price_replay = await HistoricalReplayRunner(output_dir=run_dir / "price_replay").run(
