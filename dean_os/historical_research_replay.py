...
from dean_os.outcome_evaluation import _parse_datetime
...
class HistoricalResearchReplayRunner:
    ...
    async def run(
        ...
        payload = {
            ...
            "price_replay": _compact_price_replay(price_replay),
            "research_exam": _research_exam(lab_report, price_replay),
