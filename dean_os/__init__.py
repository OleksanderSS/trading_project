...
_EXPORT_GROUPS: dict[str, tuple[str, ...]] = {
    "dean_os.branches": ("AnalyticalBranch", "PipelineBranch"),
    "dean_os.packets.build_focus_review_packet": ("BuildFocusReviewPacket",),
    "dean_os.consensus": ("ConsensusEngine",),
    "dean_os.context_performance": ("AgentPerformanceByContext",),
    "dean_os.current_architecture_map": ("CurrentArchitectureMap",),
    "dean_os.current_system_alignment_review": (
        "CurrentSystemAlignmentReview",
    ),
    "dean_os.decision_logger": ("DecisionLogger",),
    "dean_os.analyst_core.domain_analyst_case_registry_packet": (
        "DomainAnalystCaseRegistryPacket",
    ),
    "dean_os.analyst_core.domain_analyst_event_interpretation_packet": (
        "DomainAnalystEventInterpretationPacket",
    ),
    "dean_os.analyst_core.domain_analyst_feedback_loop_packet": (
        "DomainAnalystFeedbackLoopPacket",
    ),
    "dean_os.analyst_core.domain_analyst_forecast_review_packet": (
        "DomainAnalystForecastReviewPacket",
    ),
    "dean_os.analyst_core.domain_analyst_instance_contract": (
        "DomainAnalystInstanceContract",
    ),
    "dean_os.analyst_core.domain_analyst_pipeline_news_taxonomy": (
        "classify_pipeline_news_context",
    ),
    "dean_os.analyst_core.domain_analyst_portability_review": (
    ...
    "dean_os.analyst_core.domain_analyst_template_standardization_packet": (
        "DomainAnalystTemplateStandardizationPacket",
    ),
    "dean_os.analyst_core.domain_analyst_thesis_review_packet": (
        "DomainAnalystThesisReviewPacket",
    ),
    "dean_os.analyst_core.domain_analyst_intake_packet": (
    ...
    "dean_os.fundamental_input_readiness_gate": (
        "FundamentalInputReadinessGate",
    ),
    "dean_os.agent_lab": ("AgentLabRunner",),
    "dean_os.agent_learning_loop_runbook": (
        "AgentLearningLoopRunbook",
    ),
    "dean_os.analyst_core.analyst_loop_daily_check": ("AnalystLoopDailyCheck",),
    "dean_os.analyst_core.analyst_review_inbox": ("AnalystReviewInbox",),
    "dean_os.analyst_core.analyst_calibration_gate": ("AnalystCalibrationGate",),
    "dean_os.analyst_core.analyst_evidence_pack": (
        "AnalystEvidencePackRunner",
        "documents_from_evidence_pack",
    ),
    "dean_os.analyst_core.analyst_learning_apply_ceremony": (
        "AnalystLearningApplyCeremony",
    ),
    "dean_os.analyst_core.analyst_learning_promotion_bridge": (
        "AnalystLearningPromotionBridge",
    ),
    "dean_os.analyst_core.analyst_outcome_evaluation_loop": (
        "AnalystOutcomeEvaluationLoop",
    ),
    "dean_os.analyst_core.analyst_profile_orchestrator": (
        "AnalystProfileOrchestrator",
    ),
    "dean_os.analyst_core.analyst_profile_scorecard": (
        "AnalystProfileScorecard",
    ),
    "dean_os.replays.historical_replay_batch": (
        "HistoricalReplayBatchRunner",
    ),
    "dean_os.historical_replay": (
        "HistoricalReplayAnalyst",
        "HistoricalReplayRunner",
    ),
    "dean_os.historical_evidence_backfill_plan": (
        "HistoricalEvidenceBackfillPlan",
    ),
    "dean_os.historical_research_replay": (
        "HistoricalResearchReplayRunner",
    ),
    "dean_os.historical_research_replay_batch": (
        "HistoricalResearchReplayBatchRunner",
    ),
    "dean_os.learning": ("LearningStore",),
    "dean_os.market_data_refresh_runbook": (
        "MarketDataRefreshRunbook",
    ),
    "dean_os.manual_implementation_backlog": (
        "ManualImplementationBacklog",
    ),
    "dean_os.material_loaders": (
        "ingest_research_path",
        "load_research_directory",
        "load_research_document",
    ),
    "dean_os.orchestrator": ("DEANOrchestrator",),
    "dean_os.operation_queue": ("OperationQueue",),
    "dean_os.outcome_evaluation": ("OutcomeEvaluationRunner",),
    "dean_os.outcome_price_coverage_plan": (
        "OutcomePriceCoveragePlan",
    ),
    "dean_os.outcome_readiness_gate": ("OutcomeReadinessGate",),
    "dean_os.paper_autonomy": ("PaperAutonomyRunner",),
    "dean_os.agents.paper_portfolio": ("PaperPortfolioSimulator",),
    "dean_os.paper_trading": (
        "PaperTradeEvaluationRunner",
        "PaperTradeStore",
    ),
    "dean_os.pipeline_adapter": ("HybridPipelineAdapter",),
    "dean_os.pipeline_control.pipeline_control_caution_review_packet": (
        "PipelineControlCautionReviewPacket",
    ),
    "dean_os.pipeline_control.pipeline_control_bounded_evidence_batch": (
        "PipelineControlBoundedEvidenceBatch",
    ),
    "dean_os.pipeline_control.pipeline_control_bounded_evidence_run": (
        "PipelineControlBoundedEvidenceRun",
    ),
    "dean_os.pipeline_control.pipeline_control_feature_causality_audit": (
        "PipelineControlFeatureCausalityAudit",
    ),
    "dean_os.pipeline_control.pipeline_control_train_validation_diagnostic": (
        "PipelineControlTrainValidationDiagnostic",
    ),
    "dean_os.pipeline_control.pipeline_control_train_validation_experiment": (
        "PipelineControlTrainValidationExperiment",
    ),
    "dean_os.pipeline_control.pipeline_control_walk_forward_validation_run": (
        "PipelineControlWalkForwardValidationRun",
    ),
    "dean_os.pipeline_control.pipeline_control_forward_data_accrual_plan": (
        "PipelineControlForwardDataAccrualPlan",
    ),
    "dean_os.pipeline_control.pipeline_control_forward_data_accrual_gate": (
        "PipelineControlForwardDataAccrualGate",
    ),
    "dean_os.pipeline_control.pipeline_control_data_preflight": (
        "PipelineControlDataPreflight",
    ),
    "dean_os.pipeline_control.pipeline_control_saved_data_coverage": (
        "PipelineControlSavedDataCoverage",
    ),
    "dean_os.pipeline_control.pipeline_control_saved_price_repair": (
        "PipelineControlSavedPriceRepair",
    ),
    "dean_os.pipeline_control.pipeline_control_historical_price_recovery": (
    ...
    "dean_os.pipeline_control.pipeline_control_locked_evaluation_assembler": (
        "PipelineControlLockedEvaluationAssembler",
    ),
    "dean_os.pipeline_control.pipeline_control_locked_feature_stability_assembler": (
        "PipelineControlLockedFeatureStabilityAssembler",
    ),
    "dean_os.pipeline_control.pipeline_control_real_metric_evidence_run": (
        "PipelineControlRealMetricEvidenceRun",
    ),
    "dean_os.pipeline_control.pipeline_control_surface": ("PipelineControlSurface",),
    "dean_os.pipeline_control.pipeline_control_instance_contract": (
        "PipelineControlInstanceContract",
    ),
    "dean_os.pipeline_metric_input_readiness_gate": (
        "PipelineMetricInputReadinessGate",
    ),
    "dean_os.pipeline_stage23_runtime_profile": (
        "PIPELINE_STAGE23_RUNTIME_PROFILE_CONTRACT",
        "PipelineStage23RuntimeProfile",
        "render_pipeline_stage23_runtime_profile_markdown",
    ),
    "dean_os.pipeline_timeframe_lane_readiness": (
    ...
    "dean_os.research_replay_directionality_diagnostic": (
        "ResearchReplayDirectionalityDiagnostic",
    ),
    "dean_os.regime_context": (
    ...
    "dean_os.review_action_apply_ceremony": (
        "ReviewActionApplyCeremony",
    ),
    "dean_os.review_action_dry_run": ("ReviewActionDryRun",),
    ...
    "dean_os.calibration_proposal_agent": (
        "CalibrationProposalAgent",
    ),
    "dean_os.calibration_review_lifecycle": (
        "CalibrationReviewLifecycle",
    ),
    "dean_os.research_corpus": ("ResearchCorpus",),
    "dean_os.review": ("AgentReviewBuilder",),
    "dean_os.review_actions": ("ReviewActionStore",),
    "dean_os.review_approved_learning_loop": (
        "ReviewApprovedLearningLoop",
    ),
    "dean_os.sample_materials": ("agent_lab_sample_documents",),
    ...
    "dean_os.sector_thesis_to_ticker_basket_bridge": (
        "SectorThesisToTickerBasketBridge",
    ),
    "dean_os.agents.synthesis": ("EvidenceBoundSynthesizer",),
    "dean_os.ticker_focused_replay_exam_bridge": (
        "TickerFocusedReplayExamBridge",
    ),
    "dean_os.ticker_focused_research_note_builder": (
        "TickerFocusedResearchNoteBuilder",
    ),
    "dean_os.ticker_specific_attribution_audit": (
        "TickerSpecificAttributionAudit",
    ),
    "dean_os.registry": ("AgentRegistry",),
    "dean_os.schemas": (
        "AgentCapabilities",
        "AgentLabRunReport",
        "AnalyticalReport",
