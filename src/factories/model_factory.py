...
class ModelFactory:
    ...
    @staticmethod
    def _create_ensemble_model(config: dict[str, Any] | None, kwargs: dict[str, Any]) -> BaseModel:
    ...
    @staticmethod
    def _create_regular_model(model_class, canonical_name: str, config: dict[str, Any] | None, kwargs: dict[str, Any]) -> BaseModel:
