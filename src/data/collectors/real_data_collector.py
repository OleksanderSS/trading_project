...
# from src.pipeline.stages.stage_1_collectors_layer import run_stage_1_collect
...
class RealDataCollector:
    ...
    def get_real_time_data(self, tickers: List[str] = None) -> Dict[str, pd.DataFrame]:
        ...
        try:
            ...
            stage_manager = PipelineOrchestrator()
            stage1_data = stage_manager.run_stage(1, force_refresh=False)
    ...
    def get_comprehensive_market_data(self) -> Dict[str, pd.DataFrame]:
        ...
        try:
            ...
            merged_df, _, _, _ = processing_stage.execute(stage1_data)
