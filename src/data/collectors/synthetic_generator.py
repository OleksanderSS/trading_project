...
class SyntheticGenerator(BaseCollector):
    ...
    def collect_historical_data(self, ticker: str, start_date: str, end_date: str, **kwargs) -> pd.DataFrame:
        """Compatibility with BaseCollector."""
        return self.generate_scenarios(scenario_name='neutral_regime')
        
    def run(self, *args, **kwargs) -> Any:
        """Implementation of BaseCollector.run"""
        return self.generate_scenarios(scenario_name='neutral_regime')
