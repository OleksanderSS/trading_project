...
class DataFreshnessMonitor:
    ...
    async def check_all_data_sources(self, 
        ...
        for source_name, source_config in self.FRESHNESS_THRESHOLDS.items():
            try:
    ...
    async def _get_latest_timestamp(self, source_name: str) -> Optional[pd.Timestamp]:
...
def get_data_freshness_monitor(config: Optional[Dict[str, Any]] = None) -> DataFreshnessMonitor:
...
async def check_freshness_quick(config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
