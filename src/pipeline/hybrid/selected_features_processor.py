...
class SelectedFeaturesProcessor:
    ...
    async def _process_selected_features_file(self, config: ProcessSelectedFeaturesFileConfig) -> dict[str, Any] | None:
        """Process a single selected features file and return context data or None."""
        try:
            async with aiofiles.open(config.file_path, encoding='utf-8') as f:
