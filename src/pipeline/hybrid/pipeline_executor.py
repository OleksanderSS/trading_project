...
class PipelineExecutor:
    ...
    async def run_pipeline_stages(self, tickers: Optional[List[str]], 
    ...
    def create_pipeline_metadata(self, timestamp: str, tickers: Optional[List[str]], 
