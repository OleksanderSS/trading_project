...
class ModelResolver:
    ...
    def load_available_models(
        self, context_id: str, models_meta: dict[str, Any] | None = None
    ) -> dict[str, Any]:
    ...
    def _resolve_batch_directory_from_kwargs(self, kwargs: dict[str, Any]) -> Path | None:
        batch_name = kwargs.get('batch_name')
        output_dir = Path(
    ...
    def _load_heavy_models_from_disk(
        ...
        if not colab_summary_file.exists():
            colab_summary_file = batch_dir / "colab_results.json"
