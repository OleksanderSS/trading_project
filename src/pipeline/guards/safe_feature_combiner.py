...
class SafeFeatureCombiner:
    ...
    def __init__(self, alignment_guard: TimeframeAlignmentGuard | None = None):
        """
...
def get_safe_feature_combiner(alignment_guard: TimeframeAlignmentGuard | None = None) -> SafeFeatureCombiner:
...
def combine_timeframes_quick(features_by_tf: dict[str, pd.DataFrame],
                           current_time: pd.Timestamp | None = None) -> tuple[pd.DataFrame, dict[str, Any]]:
    """
