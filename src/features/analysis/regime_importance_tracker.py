...
class RegimeImportanceTracker:
    ...
    async def _calculate_importance_changes(self,
        ...
        try:
            ...
            other_regimes = {record['regime'] for record in self.importance_history} - {current_regime}
...
def get_regime_importance_tracker(config: dict[str, Any] | None = None) -> RegimeImportanceTracker:
