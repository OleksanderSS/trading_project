...
class FeatureOrchestrator:
    ...
    def __init__(self, enrichers: List[BaseEnricher], config_manager: Optional[Any] = None):
    ...
    @staticmethod
    def _process_enricher_class(obj: Type, name: str, config_manager: Any) -> Optional[BaseEnricher]:
    ...
    @staticmethod
    def _instantiate_enricher(obj: Type, enricher_id: str, config_manager: Any) -> Optional[BaseEnricher]:
    ...
    def run(self, df: pd.DataFrame, add_timeframe_suffix: bool = True, **kwargs) -> pd.DataFrame:
        """
        ...
        Args:
            ...
            add_timeframe_suffix: If True, adds timeframe suffix to feature columns (e.g., SMA_5 -> SMA_5_15m)
                                 DEFAULT: True (enabled by default for proper feature identification)
    ...
    def _run_dynamic_context_selection(self, df: pd.DataFrame, config: Dict[str, Any], run_kwargs: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            ...
            if dynamic_context_features:
                ...
                logger.info("Added {} dynamic features to kwargs for ContextMapEnricher.".format(len(dynamic_context_features)))
