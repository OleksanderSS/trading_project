...
class TradingModelArena:
    ...
    def calculate_loss_metrics(self, predictions: np.ndarray, actuals: np.ndarray, probs: Optional[np.ndarray] = None) -> Dict[str, float]:
    ...
    def _load_current_champion(self, ticker: str, target: str) -> Optional[Tuple[str, Any]]:
