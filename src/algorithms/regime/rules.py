...
class RegimeRulesEngine:
    ...
    def _check_mean_reversion(self, returns: np.ndarray) ->Optional[Dict[
        str, Any]]:
    ...
    def _check_momentum(self, returns: np.ndarray) ->Optional[Dict[str, Any]]:
    ...
    def _check_breakout(self, prices: Optional[np.ndarray], volume:
        Optional[np.ndarray]) ->Optional[Dict[str, Any]]:
