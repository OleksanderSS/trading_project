...
class UniversalNotifier:
    ...
    async def send_report(self, message: str, image_path: Optional[str] = None):
    ...
    async def _send_telegram(self, message: str, image_path: Optional[str] = None):
    ...
    async def _send_discord(self, message: str, image_path: Optional[str] = None):
