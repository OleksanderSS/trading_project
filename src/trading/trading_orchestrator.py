...
class TradingOrchestrator:
    ...
    def __init__(self, 
                 ...
                 param_manager: Optional[Any] = None,
                 regime_detector: Optional[Any] = None,
                 knn_finder: Optional[Any] = None,
                 macro_analyzer: Optional[Any] = None):
        """
    ...
    def _synthesize_consensus_signals(self, predictions_to_process: List[Dict[str, Any]], regime: str = 'neutral', enriched_data: Optional[pd.DataFrame] = None) -> List[Dict[str, Any]]:
    ...
    def _process_single_prediction(self, prediction: Dict[str, Any], ticker: str, regime: str = 'neutral', enriched_data: Optional[pd.DataFrame] = None) -> Optional[Dict[str, Any]]:
