...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run ReplayCheckpointMonitorBuilder (replay_checkpoint_monitor).")
    parser.add_argument("--output-dir", default="reports/dean_os/replay_checkpoint_monitor_current")
...
def main() -> None:
    ...
    builder = ReplayCheckpointMonitorBuilder(
