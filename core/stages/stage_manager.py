...
class StageManager:
                ...
                if cached_data and len(cached_data) > 0:
                    ...
                    if cache_time:
                        ...
                        if fresh_data_types and not stale_data_types:
                            logger.info(f"[StageManager] ✅ Всі дані свіжі, використовуємо кеш")
                            ...
                            logger.info(f"[StageManager] 🔄 Повне оновлення - всі дані застарілі")
                            for item in stale_data_types:
                                logger.info(f"  🔄 {item}")
                    else:
    ...
    def run_stage_2(self, stage1_data: Dict[str, Any], force_refresh: bool = False, 
        ...
        logger.info(f"[StageManager] DEBUG: run_stage_2_enrich_optimized повернув:")
    ...
    def _accumulate_stage2_data(self, raw_news, merged_df, pivots):
        ...
        try:
            ...
            logger.info(f"[StageManager] DEBUG: Папка створена успandшно")
            ...
            if accumulated_file.exists():
                ...
                logger.info(f"[StageManager] Об'єднано with andснуючими даними")
            else:
