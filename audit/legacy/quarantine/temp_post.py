...
Ð Ð¾Ð·Ñ€Ð°Ñ…Ð¾Ð²ÑƒÑ” Ñ‚Ð°Ñ€Ð³ÐµÑ‚Ð¸ Ð½Ð° Ð¾ÑÐ½Ð¾Ð²Ñ– ÑÐ²Ñ–Ñ‡Ð¾Ðº ÐŸÐ†Ð¡Ð›Ð¯ Ð¿ÑƒÐ±Ð»Ñ–ÐºÐ°Ñ†Ñ–Ñ— Ð½Ð¾Ð²Ð¸Ð½Ð¸
"""
...
class PostNewsTargetCalculator:
    """
    Ð Ð¾Ð·Ñ€Ð°Ñ…Ð¾Ð²ÑƒÑ” Ñ‚Ð°Ñ€Ð³ÐµÑ‚Ð¸ Ð´Ð»Ñ ÑÐ²Ñ–Ñ‡Ð¾Ðº Ð¿Ñ–ÑÐ»Ñ Ð½Ð¾Ð²Ð¸Ð½Ð¸.

    Ð›Ð¾Ð³Ñ–ÐºÐ°:
    - Ð—Ð½Ð°Ñ…Ð¾Ð´Ð¸Ñ‚ÑŒ Ð½Ð°Ð¹Ð±Ð»Ð¸Ð¶Ñ‡Ñƒ ÑÐ²Ñ–Ñ‡ÐºÑƒ Ð¿Ñ–ÑÐ»Ñ Ð¿ÑƒÐ±Ð»Ñ–ÐºÐ°Ñ†Ñ–Ñ— Ð½Ð¾Ð²Ð¸Ð½Ð¸
    - Ð Ð¾Ð·Ñ€Ð°Ñ…Ð¾Ð²ÑƒÑ” return Ð²Ñ–Ð´ Ñ†Ñ–Ð½Ð¸ Ð½Ð° Ð¼Ð¾Ð¼ÐµÐ½Ñ‚ Ð½Ð¾Ð²Ð¸Ð½Ð¸ Ð´Ð¾ N-Ð¾Ñ— ÑÐ²Ñ–Ñ‡ÐºÐ¸ Ð¿Ñ–ÑÐ»Ñ
    """

    def calculate(self, df: pd.DataFrame, **kwargs) -> pd.Series:
        """
        Ð Ð¾Ð·Ñ€Ð°Ñ…ÑƒÐ²Ð°Ñ‚Ð¸ post-news Ñ‚Ð°Ñ€Ð³ÐµÑ‚

        Args:
            df: DataFrame Ð· Ñ†Ñ–Ð½Ð¾Ð²Ð¸Ð¼Ð¸ Ð´Ð°Ð½Ð¸Ð¼Ð¸
            **kwargs: ÐŸÐ°Ñ€Ð°Ð¼ÐµÑ‚Ñ€Ð¸
                - timeframe: '15m', '60m', '1d'
                - candle_num: Ð½Ð¾Ð¼ÐµÑ€ ÑÐ²Ñ–Ñ‡ÐºÐ¸ Ð¿Ñ–ÑÐ»Ñ Ð½Ð¾Ð²Ð¸Ð½Ð¸ (1, 2, ...)
        ...
        for _idx, row in df_tf.iterrows():
            ...
            # (Ð² Ð¼ÐµÐ¶Ð°Ñ… 1 ÑÐ²Ñ–Ñ‡ÐºÐ¸ Ð½Ð°Ð·Ð°Ð´)
            ticker_news = news_df[
                (news_df['ticker'] == ticker) | (news_df.get('news_type', 'general') == 'general')
            ]

            # Ð—Ð½Ð°Ð¹Ñ‚Ð¸ Ð½Ð¾Ð²Ð¸Ð½Ð¸ Ñ‰Ð¾ Ð±ÑƒÐ»Ð¸ Ð¾Ð¿ÑƒÐ±Ð»Ñ–ÐºÐ¾Ð²Ð°Ð½Ñ– Ð½ÐµÐ·Ð°Ð´Ð¾Ð²Ð³Ð¾ Ð´Ð¾ Ð¿Ð¾Ñ‚Ð¾Ñ‡Ð½Ð¾Ñ— ÑÐ²Ñ–Ñ‡ÐºÐ¸
            ...
            # Ð—Ð½Ð°Ð¹Ñ‚Ð¸ N-Ñƒ ÑÐ²Ñ–Ñ‡ÐºÑƒ Ð¿Ñ–ÑÐ»Ñ Ð½Ð¾Ð²Ð¸Ð½Ð¸
